...
\begin{cobolCodeSection}{orange!60}{Elektronische Zeichenprüfung (INSPECT TALLYING)}
\begin{lstlisting}[language=Cobol]
  MOVE 0 TO WS-CNT.
...
\begin{cobolCodeSection}{orange!60}{Numerische Prüfung}
\begin{lstlisting}[language=Cobol]
  IF WS-STUNDEN(1:1) = "-"
...
\begin{cobolCodeSection}{orange!60}{Mehrfach-Trenner prüfen}
\begin{lstlisting}[language=Cobol]
  MOVE 0 TO WS-CNT.
...
\begin{cobolCodeSection}{orange!60}{Datum zerlegen und prüfen}
\begin{lstlisting}[language=Cobol]
...
\begin{cobolCodeSection}{orange!60}{Fehlerlog schreiben (STRING → WRITE)}
\begin{lstlisting}[language=Cobol]
...
\begin{cobolCodeSection}{orange!60}{Fehlerzähler erhöhen}
\begin{lstlisting}[language=Cobol]
  ADD 1 TO CNT-ERROR.
\end{lstlisting}
\end{cobolCodeSection}
