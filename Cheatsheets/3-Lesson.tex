...
\begin{cobolCodeSection}{orange!60}{Arrays in Cobol}
...
\begin{cobolCodeSection}{orange!60}{Consolen Eingaben in Cobol}
\begin{lstlisting}[language=Cobol] 
  ACCEPT EINGABE.
\end{lstlisting}
...
\begin{cobolCodeSection}{orange!60}{Systemcalls in Cobol}
\begin{lstlisting}[language=Cobol] 
...
\begin{cobolCodeSection}{orange!60}{Floating Points in Cobol}
\begin{lstlisting}[language=Cobol] 
...
\begin{cobolCodeSection}{orange!60}{Zufallszahlen in Cobol}
\begin{lstlisting}[language=Cobol] 
