...
\begin{cobolTableSection}{cyan!60}{COBOL Datentypen}
\centering
...
\begin{cobolCodeSection}{cyan!60}{Variablen}
...
\begin{cobolTableSection}{cyan!60}{Ablaufsteuerung}
\centering
\begin{tabular}{|l|l|l|}
\hline
...
\begin{cobolCodeSection}{cyan!60}{Methoden}
\begin{lstlisting}[language=Cobol] 
    PROCEDURE DIVISION.
        BEGIN.
...
\begin{cobolTableSection}{cyan!60}{Cobol Funktionen}
\centering
...
\begin{cobolCodeSection}{cyan!60}{Vollständiges Beispiel}
\begin{lstlisting}[language=Cobol] 
