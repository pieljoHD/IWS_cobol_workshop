       ...
       SHOW-INSTRUCTIONS.
           ...
           DISPLAY "TIC-TAC-TOE"
           DISPLAY " "
           DISPLAY "The player and the Computer take turn."
           DISPLAY "Player 1 uses X"
           DISPLAY "Computer uses O"
           DISPLAY " "
       ...
       COMPUTER-MOVE.
           MOVE 'N' TO VALID-MOVE
           PERFORM UNTIL VALID-MOVE = 'Y'
               COMPUTE RANDOM-REAL = FUNCTION RANDOM
               COMPUTE RANDOM-NUMBER = (RANDOM-REAL * 9) + 1

               IF CELL(RANDOM-NUMBER) = SPACE
                   MOVE PLAYER-MARK TO CELL(RANDOM-NUMBER)
                   ADD 1 TO MOVE-COUNT
                   MOVE 'Y' TO VALID-MOVE
               END-IF
           END-PERFORM.
